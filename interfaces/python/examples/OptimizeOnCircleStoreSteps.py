...
print("inner: ", stats.getInnerIters())
print("subpr: ", stats.getSubproblemIters())
print("alpha: ", stats.getStepLength())
print("norm pk: ", stats.getStepSize())
print("statVals: ", stats.getStatVals())
print("objVals: ", stats.getObjVals())
print("phiVals: ", stats.getPhiVals())
print("meritVals: ", stats.getMeritVals())